namespace KnowledgeSystem.Views._04_SystemAdministrator._02_SystemAdmin
{
    partial class uc402_KPIWeb
    {
        ...
        private void InitializeComponent()
        {
            ...
            gridFormatRule5.ColumnApplyTo = this.gridColumn16;
            gridFormatRule5.Name = "90";
            formatConditionRuleExpression5.Appearance.BackColor = System.Drawing.Color.White;
            formatConditionRuleExpression5.Appearance.BackColor2 = System.Drawing.Color.Green;
            formatConditionRuleExpression5.Appearance.Options.UseBackColor = true;
            formatConditionRuleExpression5.Expression = "[data.MgrScore] == \'優\'";
            gridFormatRule5.Rule = formatConditionRuleExpression5;
            gridFormatRule6.Column = this.gridColumn16;
            gridFormatRule6.ColumnApplyTo = this.gridColumn16;
            gridFormatRule6.Name = "86";
            formatConditionRuleExpression6.Appearance.BackColor = System.Drawing.Color.White;
            formatConditionRuleExpression6.Appearance.BackColor2 = System.Drawing.Color.Yellow;
            formatConditionRuleExpression6.Appearance.Options.UseBackColor = true;
            formatConditionRuleExpression6.Expression = "[data.MgrScore] == \'良\'";
            gridFormatRule6.Rule = formatConditionRuleExpression6;
            gridFormatRule7.Column = this.gridColumn16;
            gridFormatRule7.ColumnApplyTo = this.gridColumn16;
            gridFormatRule7.Name = "70";
            formatConditionRuleExpression7.Appearance.BackColor = System.Drawing.Color.White;
            ...
            formatConditionRuleExpression7.Expression = "[data.MgrScore] == \'乙\'";
            gridFormatRule7.Rule = formatConditionRuleExpression7;
            gridFormatRule8.Column = this.gridColumn10;
            gridFormatRule8.ColumnApplyTo = this.gridColumn10;
            gridFormatRule8.Name = "edit";
            formatConditionRuleExpression8.Appearance.ForeColor = System.Drawing.Color.Red;
            formatConditionRuleExpression8.Appearance.Options.UseForeColor = true;
            formatConditionRuleExpression8.Expression = "StartsWith([data.DeptComments], \'⚠️\')";
            gridFormatRule8.Rule = formatConditionRuleExpression8;
            this.gvData.FormatRules.Add(gridFormatRule5);
            this.gvData.FormatRules.Add(gridFormatRule6);
            this.gvData.FormatRules.Add(gridFormatRule7);
            this.gvData.FormatRules.Add(gridFormatRule8);
            ...
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.uc402_KPIWeb_KeyDown);
